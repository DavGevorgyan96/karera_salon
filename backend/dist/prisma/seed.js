...
async function main() {
    ...
    if (reviewsCount === 0) {
        await prisma.review.createMany({
            data: [
                { clientName: 'Ольга', rating: 5, text: 'Прекрасный салон! Очень довольна стрижкой.', status: client_1.ReviewStatus.APPROVED },
                { clientName: 'Наталья', rating: 4, text: 'Маникюр сделали хорошо, но пришлось подождать 5 минут.', status: client_1.ReviewStatus.APPROVED },
                { clientName: 'Ирина', rating: 5, text: 'Косметолог Елена - просто волшебница!', status: client_1.ReviewStatus.APPROVED },
            ],
        });
